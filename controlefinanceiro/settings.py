...
SECRET_KEY = 'django-insecure-k9+p#=h&mu=aa7fsc5py0s3#fnkmsyk1h#rvtsxo5mpx0abrl2'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'pythoncontrolefinanceirojv.pythonanywhere.com']
...
# STATICFILES_DIRS = [BASE_DIR / 'controlefinanceiro' / 'static',]
